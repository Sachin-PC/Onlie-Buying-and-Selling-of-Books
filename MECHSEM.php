...
$res=mysqli_query($conn,"SELECT * FROM `seller` WHERE Branch='Mechanical'");
?>
<!DOCTYPE html>
<html>
<head>
...
<button onclick="myFunction()" class="dropbtn">SEMESTER</button>
  <div id="myDropdown" class="dropdown-content">
    <a href="ME1.php">FIRST</a>
    <a href="ME2.php">SECOND</a>
    <a href="ME3.php">THIRD</a>
	<a href="ME4.php">FOURTH</a>
	<a href="ME5.php">FIFTH</a>
	<a href="ME6.php">SIXTH</a>
	<a href="ME7.php">SEVENTH</a>
	<a href="ME8.php">EIGHTH</a>
  </div>
</div>
</div>
<div id="sellh">
...
<div id="Reqbook">
 ...
 <div class="req">
 <?php
$res=mysqli_query($conn,"SELECT * FROM `buyer`WHERE Branch='Mechanical'");
print"<hr>";
while($arr=mysqli_fetch_array($res))
{
	print"<strong>BookName:</strong>{$arr['Bookname']}<br>";
