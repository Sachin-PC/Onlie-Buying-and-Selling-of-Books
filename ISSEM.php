...
$res=mysqli_query($conn,"SELECT * FROM `seller` WHERE Branch='Information Science'");
?>
<!DOCTYPE html>
<html>
<head>
...
<button onclick="myFunction()" class="dropbtn">SEMESTER</button>
  <div id="myDropdown" class="dropdown-content">
    <a href="IS1.php">FIRST</a>
    <a href="IS2.php">SECOND</a>
    <a href="IS3.php">THIRD</a>
	<a href="IS4.php">FOURTH</a>
	<a href="IS5.php">FIFTH</a>
	<a href="IS6.php">SIXTH</a>
	<a href="IS7.php">SEVENTH</a>
	<a href="IS8.php">EIGHTH</a>
  </div>
</div>
<div id="sellh">
...
<div id="Reqbook">
 ...
 <div class="req">
 <?php
$res=mysqli_query($conn,"SELECT * FROM `buyer`WHERE Branch='Information Science'");
print"<hr>";
while($arr=mysqli_fetch_array($res))
{
	print"<strong>BookName:</strong>{$arr['Bookname']}<br>";
