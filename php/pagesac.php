...
<ul> 
  ...
  <h1><img src="images.jpg" alt="image" width="50" height="50"> BOOKSTURNERS </h1>
      <input id="search-button" name="submit" type="submit" value="Search!">
	   <input id="search-bar" name="search" type="text" placeholder="Author/Book for sell">
	   <input id="search-button" name="submit1" type="submit" value="Search!">
	   <input id="search-bar" name="search1" type="text" placeholder="Author/Book for buy">
  </ul>
  
  <div style="padding:95px;margin-top:-10px;height:500px;">
