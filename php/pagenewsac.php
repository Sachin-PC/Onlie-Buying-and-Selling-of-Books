...
if(isset($_POST['btn-search']))
{
 $sear=$_POST['Search'];
 $_SESSION['xxx']=$sear;
 header("Location: Searchselnew.php");
 }
?>
<!DOCTYPE html>
<html>
...
<ul> 
  ...
  <h1><img src="images.jpg" alt="image" width="50" height="50"> BOOKSTURNERS </h1>
      <input type="text" name="Search" placeholder="BookName or Author" required />
	  <button type="submit" name="btn-search">SEARCH</button>
	   <button input id="search-button" name="submit1" type="submit" value="Search!" ></button>
