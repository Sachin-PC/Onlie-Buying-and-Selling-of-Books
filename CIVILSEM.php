...
<button onclick="myFunction()" class="dropbtn">SEMESTER</button>
  <div id="myDropdown" class="dropdown-content">
    <a href="CIVIL1.php">FIRST</a>
    <a href="CIVIL2.php">SECOND</a>
    <a href="CIVIL3.php">THIRD</a>
	<a href="CIVIL4.php">FOURTH</a>
	<a href="CIVIL5.php">FIFTH</a>
	<a href="CIVIL6.php">SIXTH</a>
	<a href="CIVIL7.php">SEVENTH</a>
	<a href="CIVIL8.php">EIGHTH</a>
  </div>
</div>
<div id="sellh">
...
<div id="Reqbook">
 ...
 <div class="req">
 <?php
$res=mysqli_query($conn,"SELECT * FROM `buyer`WHERE Branch='CIVIL'");
print"<hr>";
while($arr=mysqli_fetch_array($res))
{
	print"<strong>BookName:</strong>{$arr['Bookname']}<br>";
